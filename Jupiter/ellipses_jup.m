...
[E2,Ev2,~,~,A2,Av2,~,~]= earsunsatjup(xe,ve,xs,vs,xa,va,xj,vj);
...
[E3,Ev3,S,Sv,A3,Av3,~,~]= earsunsatjup(xe,ve,xs,vs,xa,va,xj,vj);


hold on;

axis([-6.3369 6.3369 -6.3369 6.3369 -0.033369 0.033369])
